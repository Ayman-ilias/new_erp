...
backend_dir = Path(__file__).parent / "shad-theme-dashboard" / "backend"
    ...
    with engine.connect() as conn:
        ...
        try:
            ...
            delete_order = [
                ...
                "smv_calculations",
                "order_management",
                "users",  # Keep users table but clear non-admin users
            ]
            ...
            # Delete from any remaining tables
            remaining_tables = [t for t in tables if t not in delete_order]
            ...
            print("=" * 60)
            print("\nNote: Admin user accounts are preserved.")
