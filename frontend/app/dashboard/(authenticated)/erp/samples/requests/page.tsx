...
import { Edit, Trash2, Search, X, Eye, Upload, Check, ChevronsUpDown, FileText, Info, RefreshCw } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const requestData = {
        ...
        yarn_handover_date: formData.yarn_handover_date || null,
        trims_handover_date: formData.trims_handover_date || null,
        ...
        additional_instruction: formData.additional_instruction || null,
